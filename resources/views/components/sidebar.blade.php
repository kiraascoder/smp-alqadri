 <header
     class="fixed top-0 left-0 right-0 z-50 bg-white shadow-lg flex items-center justify-between px-4 py-3 lg:hidden">
     <!-- Hamburger Button -->
     ...
     <div class="p-6 border-b border-blue-700">
         <div class="text-center">
             ...
             <div class="bg-blue-800 rounded-lg p-3">
                 ...
                 <p class="text-xs text-blue-300 mt-1">Administrator</p>
             </div>
         </div>
     </div>
