        ...
        <div class="max-w-7xl mx-auto space-y-8">
            ...
            <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                <div class="space-y-2">
                    ...
                    <p class="text-gray-600 text-lg">Kelola data orang tua dengan mudah dan efisien</p>
                </div>
                ...
                <div class="bg-gradient-to-r from-gray-50 to-gray-100 px-8 py-6 border-b border-gray-200">
                    <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                <h2 class="text-2xl font-bold text-gray-800">Data Orang Tua Siswa</h2>
                                <p class="text-gray-600">Daftar lengkap orang tua siswa sekolah</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center gap-2 text-sm text-gray-500">
                            ...
                            <span>Total: {{ $ortu->total() }} data</span>
                        </div>
                    </div>
                </div>
                                ...
                                <tr class="hover:bg-blue-50/50 transition-colors duration-200 group"
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div
                                            ...
                                            {{ ($ortu->currentPage() - 1) * $ortu->perPage() + $loop->iteration }}
                                        </div>
                                    </td>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center justify-center gap-2">
                                            ...
                                            <!-- Tombol Hapus -->
                                            <button
                                                onclick="confirmDelete({{ $item->id }}, '{{ $item->name ?? 'Orang Tua' }}')"
                                    ...
                                    <td colspan="6" class="px-6 py-12 text-center">
                                        <div class="flex flex-col items-center gap-4">
                                            ...
                                            <div class="text-center">
                                                ...
                                                <p class="text-gray-500">Belum ada orang tua yang terdaftar</p>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
                    ...
                    <div class="bg-gray-50/50 px-6 py-4 border-t border-gray-200">
                        <div class="flex flex-col sm:flex-row items-center justify-between gap-4">
                            ...
                            <div class="text-sm text-gray-600">
                                Menampilkan <span class="font-semibold text-gray-900">{{ $ortu->firstItem() }}</span>
                                sampai <span class="font-semibold text-gray-900">{{ $ortu->lastItem() }}</span>
                                dari <span class="font-semibold text-gray-900">{{ $ortu->total() }}</span> hasil
                            </div>
                            ...
                            <div class="flex items-center gap-2">
                                ...
                                <!-- Page Numbers -->
                                @foreach ($ortu->getUrlRange(1, $ortu->lastPage()) as $page => $url)
                                    @if ($page == $ortu->currentPage())
                                        <span
                                ...
                                <!-- Next Page Link -->
                                @if ($ortu->hasMorePages())
                                    <a href="{{ $ortu->nextPageUrl() }}"
                                        class="px-3 py-2 text-sm font-medium text-gray-600 bg-white border border-gray-200 rounded-lg hover:bg-gray-50 hover:text-gray-800 transition-all duration-200">
                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                d="M9 5l7 7-7 7" />
            ...
            <div class="bg-gradient-to-r from-green-600 to-emerald-600 text-white p-6 rounded-t-2xl flex-shrink-0">
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <h3 class="text-xl font-bold">Tambah Orang Tua Baru</h3>
                            <p class="text-green-100">Daftarkan Orang Tua baru ke sistem</p>
                        </div>
                    </div>
            ...
            <div class="flex-1 overflow-y-auto p-6">
                <form id="addSiswaForm" action="{{ route('admin.orang.register') }}" method="POST" class="space-y-6">
                    ...
                    <div class="space-y-4">
                        <!-- Pilih Anak -->
                        <div>
                            <label for="anak" class="block text-sm font-medium text-gray-700 mb-2">
                                Pilih Anak (Bisa lebih dari satu) <span class="text-red-500">*</span>
                            </label>
                            <select id="anak" name="anak[]" multiple required
                                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors duration-200">
                            ...
                            <small class="text-gray-500">Tekan Ctrl (atau Cmd) untuk memilih lebih dari satu anak.</small>
                        </div>
                ...
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-blue-100">Informasi lengkap data orang tua</p>
                        </div>
                    </div>
            ...
            <div class="p-6">
                <div class="flex items-center gap-4 mb-4">
                    ...
                    <div>
                        ...
                        <p class="text-gray-600">Apakah Anda yakin ingin menghapus data orang tua ini?</p>
                    </div>
                </div>
    ...
    <script>
        ...
        function showDetail(button) {
            ...
            const data = {
                ...
                telepon: row.dataset.no_hp,
                jenisKelamin: row.dataset.jenisKelamin,
                tanggalLahir: row.dataset.tanggalLahir,
                anak: (() => {
                    try {
                        const anakData = row.dataset.anak;
                        console.log('Raw anak data:', anakData);

                        if (!anakData || anakData === '-' || anakData === '[]') return '-';

                        const anakArray = JSON.parse(anakData);
                        console.log('Parsed anak array:', anakArray);

                        if (!Array.isArray(anakArray) || anakArray.length === 0) return '-';


                        const namaAnak = anakArray
                            .map(item => {
                                // Ambil nama dari struktur yang sudah disederhanakan
                                return item.name && item.name !== '-' ? `${item.name} (${item.nisn})` :
                                    null;
                            })
                        ...
                        console.error('Error parsing anak data:', error, 'Raw data:', row.dataset.anak);
                        return '-';
                    }
                })(),
            };
        ...
        <div class="space-y-6">
            ...
            <div class="bg-blue-50 rounded-lg p-6 border border-blue-200">
                <div class="flex items-center gap-2 mb-3">
                    ...
                    <label class="text-sm font-semibold text-blue-800">Daftar Anak</label>
                </div>
                <div class="bg-white rounded-lg p-4">
                    <p class="text-gray-900 font-medium">${data.anak}</p>
                </div>
            </div>
        </div>
    `;
        ...
        function confirmDelete(id, name) {
            ...
            document.getElementById('deleteForm').action = `/admin/orang-tua/${id}`;
        ...
        // Function untuk membuka modal tambah siswa
        function openModal() {
            // Reset form
        ...
        // Function untuk menutup modal tambah siswa
