...
<body class="p-6 bg-gray-100 text-gray-900">
    ...
    <h2 class="text-xl font-bold mb-4">Register Guru BK</h2>
    ...
    <form method="POST" action="{{ route('admin-bk.tambah') }}" class="mb-8 bg-white p-4 rounded shadow">
        @csrf
        <div class="mb-4">
    ...
    @foreach ($guru as $index)
        <div class="flex items-center gap-4 bg-white p-4 rounded shadow mb-2">
            ...
            <div class="flex gap-2">
                ...
                <form action="{{ route('admin-bk.delete', $index->id) }}" method="POST"
        ...
        <div id="modal-edit-{{ $index->id }}"
            ...
            <div class="bg-white p-6 rounded shadow w-full max-w-lg mx-auto relative">
                ...
                <form action="{{ route('admin-bk.edit', $index->id) }}" method="POST">
                    @csrf
                    @method('PUT')
